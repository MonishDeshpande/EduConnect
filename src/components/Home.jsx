  ...
  return (
    <>
      <div class="bg-slate-900">
          ...
          <div class="max-w-[85rem] mx-11 px-4 sm:px-4 lg:px-8 py-14 space-y-8">
            <div class="ml-28 max-w-5xl flex flex-row">
              <h1 class=" block font-medium text-white text-5xl sm:text-5xl md:text-6xl lg:text-7xl">
                Welcome to <span className="text-blue-600">EduConnect</span> the
                best way to showcase your projects.
              </h1>

              <img
                className="get_img w-0 sm:w-0 md:w-32 lg:w-48 ml-60"
                src={require("../pictures/problem.png")}
                alt=""
              />
            </div>
            ...
            <div class="max-w-3xl pt-5 text-center mx-auto">
              <p class="text-lg text-gray-400">
                Showcase your project and get hired by top companies
              </p>
            </div>
            ...
            <div class="text-center">
              <Link
                to="/getstarted"
                class="inline-flex items-center gap-x-3 text-center bg-gradient-to-tl from-blue-600 to-violet-600 shadow-lg shadow-transparent hover:shadow-blue-700/50 border border-transparent text-white text-sm font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white py-3 px-6  focus:ring-offset-gray-800">
                Get started
                <svg
        ...
        <div class="max-w-[85rem] px-4  sm:px-6 lg:px-8 lg:py-4 mx-auto">
          <div class="max-w-[85rem] px-4  sm:px-6 lg:px-8 lg:py-4 mx-auto">
            <div class="sm:w-1/2 xl:w-1/3 mx-auto text-center mb-6">
              <h2 class="text-xl font-semibold md:text-2xl md:leading-tight text-white">
                Students of our platform got placed at top companies
              </h2>
            </div>
            ...
            <div class="my-8 md:my-16 grid grid-cols-3 sm:flex sm:justify-center gap-6 sm:gap-x-12 lg:gap-x-20">
              <a class="flex-shrink-0 transition hover:-translate-y-1" href="#">
                <svg
                  class="size-6 md:size-10 mx-auto sm:mx-0"
                  width="48"
                  height="55"
                  viewBox="0 0 48 55"
                  fill="none"
        ...
        <h1 classNameName=" text-gray-200 text-4xl font-bold mx-20 pb-5">
          Why EduConnect ?
        </h1>
      </div>
      ...
      <div className="max-w-[100rem] px-4 sm:px-6 lg:px-8  mx-auto">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-3 xl:gap-6">
          <Link
            to={user ? `/projects/Addproj/${user._doc.id_p}` : `/login`}
            className="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all  hover:bg-white/[.075]"
            href="#">
            <svg
              className="flex-shrink-0 w-8 h-8 text-gray-800 mt-0.5 mr-6  text-white"
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              fill="currentColor"
            ...
            <div>
              <div>
                ...
                <p className="text-gray-400">
                  Gain recognition and visibility by showcasing your projects to
                  a wide audience.
                </p>
              </div>
          ...
          <Link
            ...
            href="#">
            <svg
              className="flex-shrink-0 w-8 h-8 text-white mt-0.5 mr-6"
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              fill="currentColor"
            ...
            <div>
              <div>
                ...
                <p className=" text-gray-400">
                  Click here to embark on an exhilarating journey into the realm
          ...
          <Link to="/PostHack">
            <a
              class="group flex gap-y-6 w-full h-full hover:bg-gray-100 rounded-lg p-5 transition-all  hover:bg-white/[.075]"
              href="#">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-16 h-16"
              ...
              <div>
                <div>
                  <h3 className="block font-bold ml-3 text-gray-800 text-white">
                    Compete in Hackathons
                  </h3>
                  <p className="ml-3  text-gray-400">
                    Get Updates on various events, hackathons and hiring
                    challenges
                  </p>
                </div>
          ...
          <Link to="Qa">
            <a
              ...
              <div>
                <div>
                  <h3 className="block ml-3 font-bold text-white">
                    Question and answers Forums
                  </h3>
                  <p className="ml-3 text-gray-400">
                    Your Questions, Our Community, Endless Answers.
                  </p>
                </div>
